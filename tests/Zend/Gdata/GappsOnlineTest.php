...
class Zend_Gdata_GappsOnlineTest extends TestCase
{
    ...
    public function testCanRemoveOwnerFromGroup()
    {
        ...
        $this->gdata->removeOwnerFromGroup(
            $user->login->username,
            $generatedGroupName
        );
    ...
    public function testCanRetrievePageOfRecipients()
    {
        ...
        for ($i = 0; $i < $userCount; $i++) {
            ...
            $this->autoDelete($user);
            $this->gdata->addRecipientToEmailList(
                $generatedUsername,
                $generatedListName
            );
        }
    ...
    public function testCanDeleteEmailListRecipient()
    {
        ...
        $this->gdata->removeRecipientFromEmailList(
            $user->login->username,
            $generatedListName
        );
